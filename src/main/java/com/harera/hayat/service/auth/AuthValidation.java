...
import static com.harera.hayat.util.ErrorCode.FORMAT_RESET_PASSWORD_MOBILE;
import static com.harera.hayat.util.ErrorCode.FORMAT_RESET_PASSWORD_NEW_PASSWORD;
import static com.harera.hayat.util.ErrorCode.FORMAT_RESET_PASSWORD_OTP;
import static com.harera.hayat.util.ErrorCode.FORMAT_SIGNUP_EMAIL;
...
import static com.harera.hayat.util.ErrorCode.FORMAT_SIGNUP_PASSWORD;
import static com.harera.hayat.util.ErrorCode.INVALID_LOGIN_CREDENTIALS;
...
import static com.harera.hayat.util.ErrorCode.MANDATORY_RESET_PASSWORD_MOBILE;
import static com.harera.hayat.util.ErrorCode.MANDATORY_RESET_PASSWORD_NEW_PASSWORD;
import static com.harera.hayat.util.ErrorCode.MANDATORY_RESET_PASSWORD_OTP;
...
import static com.harera.hayat.util.ErrorCode.MANDATORY_SIGNUP_OTP;
import static com.harera.hayat.util.ErrorCode.MANDATORY_SIGNUP_PASSWORD;
import static com.harera.hayat.util.ErrorCode.NOT_FOUND_RESET_PASSWORD_MOBILE;
...
import static com.harera.hayat.util.SubjectUtils.getSubject;
...
public class AuthValidation {
    ...
    private void validatePassword(LoginRequest loginRequest) {
        ...
        if (!encoder.matches(loginRequest.getPassword(), user.getPassword())) {
            throw new LoginException(INVALID_LOGIN_CREDENTIALS,
