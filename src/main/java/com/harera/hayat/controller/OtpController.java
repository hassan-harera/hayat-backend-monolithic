...
import com.harera.hayat.service.otp.OtpService;
...
public class OtpController {
    ...
    @Operation(summary = "Request otp",
                    description = "Request to send an otp to mobile number to signup or reset password",
                    tags = "Authentication",
                    responses = {
    ...
    public ResponseEntity<Void> validate(@RequestParam(name = "otp") String otp,
